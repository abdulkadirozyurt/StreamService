...
public class StreamInformationManager(IStreamInformationDal streamInformationDal)
    : EntityManagerBase<StreamInformation>(streamInformationDal),
        IStreamInformationService
{
